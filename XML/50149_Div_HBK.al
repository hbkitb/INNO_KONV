xmlport 50150 "50150_Posting_Setup_ERPG"
{
    ...
    begin
        ...
        if svar = 1 then begin
            ...
            IF GenPostSetup.FINDSET THEN
                REPEAT
                    ...
                    GenPostSetup."COGS Account" := '13800';  //Felt03;  forbrugskonto
                                                             //hIF STRLEN(Felt07) = 4 THEN
                                                             //h   Felt07 := '0' + Felt07;
                                                             //hIF STRLEN(Felt07) = 5 THEN
                    GenPostSetup."Inventory Adjmt. Account" := '13760';  //Felt07;
                    GenPostSetup."Direct Cost Applied Account" := '13800';  //modkonto køb
                    GenPostSetup."Overhead Applied Account" := '13800';     //modkonto køb

                    GenPostSetup."Purchase Variance Account" := '13800';    //Købsafvigelse
                    GenPostSetup.MODIFY;
        ...
        if svar = 2 then begin
            GenPostSetup.RESET;
            GenPostSetup.SETRANGE("Gen. Prod. Posting Group", Felt01);
            ...
            IF GenPostSetup.FINDSET THEN
                REPEAT
                    ...
                    GenPostSetup."Purch. Credit Memo Account" := Felt03;  //'13800';
                                                                          ...
                                                                          //h   Felt03 := '0' + Felt03;
                                                                          //hIF STRLEN(Felt03) = 5 THEN
                    GenPostSetup."COGS Account" := '13800';  //Felt03;
                                                             //hIF STRLEN(Felt07) = 4 THEN
                                                             //h   Felt07 := '0' + Felt07;
                                                             //hIF STRLEN(Felt07) = 5 THEN
                    GenPostSetup."Inventory Adjmt. Account" := '13760';  //Felt07;
        ...
        IF svar = 3 then begin
            ...
            IF GenVareSetup.FINDSET THEN
                REPEAT
                    ...
                    GenVareSetup."Inventory Account" := Felt06;
                    GenVareSetup.MODIFY;
        ...
        if svar = 1 then begin
            ...
            IF CustPost.FINDSET THEN
                REPEAT
                    ...
                    CustPost."Payment Disc. Debit Acc." := Felt04;
                    CustPost."Payment Disc. Credit Acc." := Felt04;

                    CustPost."Interest Account" := '44300';
                    CustPost."Additional Fee Account" := '10500';

                    CustPost."Invoice Rounding Account" := '37720';
                    CustPost."Debit Curr. Appln. Rndg. Acc." := '37720';
                    CustPost."Credit Curr. Appln. Rndg. Acc." := '37720';
                    CustPost."Debit Rounding Account" := '37720';
                    CustPost."Credit Rounding Account" := '37720';
                    CustPost."Payment Tolerance Debit Acc." := '37720';
                    CustPost."Payment Tolerance Credit Acc." := '37720';
