        ...
        IF FinKart.FINDSET then
            repeat
                if Felt02 <> '' then begin
                    ...
                    if Felt02 = '2' then begin
                        FinKart."Gen. Posting Type" := FinKart."Gen. Posting Type"::Sale;
                        FinKart."Gen. Bus. Posting Group" := 'INDLAND';
                        FinKart."Gen. Prod. Posting Group" := 'DIVERSE';
                        FinKart."VAT Bus. Posting Group" := 'INDLAND';
                        FinKart."VAT Prod. Posting Group" := 'MOMS';
                        FinKart.Modify();
                    end;

                    if Felt02 = '1' then begin
